...
function atualizarInterface() {
    ...
    if (mediaTotalEl)
        mediaTotalEl.innerText = minhaTurma.getNumAlunos().toString();
    if (mediaIdadeEl)
        mediaIdadeEl.innerText = minhaTurma.getMediaIdade();
    if (mediaAlturaEl)
        mediaAlturaEl.innerText = minhaTurma.getMediaAlturas() + "m";
    if (mediaPesoEl)
        mediaPesoEl.innerText = minhaTurma.getMediaPesos() + "kg";
    if (listaULEl) {
        listaULEl.innerHTML = "";
